...
public class CreateRoutineCmdType : InputObjectType<CreateRoutine>
{
    protected override void Configure(IInputObjectTypeDescriptor<CreateRoutine> descriptor)
    {
        descriptor
            .Name("CreateRoutineCmd")
            .Description("The Command for creating a Routine.");
        ...
        descriptor
            .Field(x => x.PurposeId)
            .Name("purposeId")
            .Description("The unique identifier of the Job Purpose that will be created by this Routine.");
