...
<template>
  <div
    tabindex="-1"
    v-bind="modalStore.isGlobalModalOpen ? { 'aria-modal': 'true' } : { 'aria-hidden': 'true' }"
  >
    <transition name="fade" appear>
      <div
        v-if="modalStore.isGlobalModalOpen"
          ...
          >
            ...
            >
              ...
              <fwb-button
                ...
                :class="[!props.set_margins && props.title ? 'mr-4 lg:mr-6' : ''].join('')"
              >
                <svg
                  class="w-3 h-3"
