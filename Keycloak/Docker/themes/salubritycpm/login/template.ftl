...
<body class="grid grid-cols-12 gap-0 justify-between font-graphik ${properties.theme!'light'}">
...
<#--        <@components.footer/>-->
    ...
    <div class="fixed h-full w-full grid grid-cols-6 md:grid-cols-12 gap-x-8 -z-50">
        <div class="bg-pink-200 bg-opacity-20"></div>
        <div class="bg-pink-200 bg-opacity-20"></div>
        <div class="bg-pink-200 bg-opacity-20"></div>
        <div class="bg-pink-200 bg-opacity-20"></div>
        <div class="bg-pink-200 bg-opacity-20"></div>
